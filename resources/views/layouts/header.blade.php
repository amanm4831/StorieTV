...
<head>
        ...
        <!-- color picker css -->
        <link rel="stylesheet" href="{{url('assets/libs/%40simonwep/pickr/themes/classic.min.css')}}"/> <!-- 'classic' theme -->
        <link rel="stylesheet" href="{{url('assets/libs/%40simonwep/pickr/themes/monolith.min.css')}}"/> <!-- 'monolith' theme -->
        <link rel="stylesheet" href="{{url('assets/libs/%40simonwep/pickr/themes/nano.min.css')}}"/> <!-- 'nano' theme -->
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            ...
                            <span class="logo-lg">
                                <img src="{{url('assets/images/logo-sm.svg')}}" alt="" height="24"> <span class="logo-txt">StoryTV</span>
                            </span>
                        </a>
